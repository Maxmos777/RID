...
export const customUseStartRecording = (
  ...
  return useStartRecording(
    audioContextRef, microphoneRef, analyserRef, wsRef, mediaStreamRef,
    setIsRecording, playNextAudioChunk, isPlayingRef, audioQueueRef,
    workletCode, processorRef, setStatus,
  );
};
