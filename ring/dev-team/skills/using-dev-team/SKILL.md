...
| **`ring:backend-engineer-python`**          | Django, FastAPI, django-tenants, PostgreSQL, pytest/ruff, httpx, ADR-aligned async ORM patterns        | Python SaaS backend, multi-tenant Django, FastAPI on ASGI, Langflow/Stripe integration |
