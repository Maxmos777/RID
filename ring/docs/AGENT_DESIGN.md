...
**Used by:** `ring:backend-engineer-golang`, `ring:backend-engineer-typescript`, `ring:backend-engineer-python`, `frontend-bff-engineer-typescript`, `ring:devops-engineer`, `ring:qa-analyst`, `ring:sre`, `finops-automation`
...
| `ring:backend-engineer-python` | `docs/PROJECT_RULES.md` + `docs/adr/` | Django/FastAPI, ADR-001–00N, pytest/ruff |
