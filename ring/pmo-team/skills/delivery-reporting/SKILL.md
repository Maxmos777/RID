...
|---|---|---|
| Process Groups Practice Guide (EN) | `../docs/standards/project-management/process-groups-practice-guide-eng.pdf` | Mapear entregas da squad às entradas/saídas esperadas por fase |
| Earned Value Management Standard | `../docs/standards/project-management/earned-value-management-standard.pdf` | Uniformizar relatórios de squads com indicadores EVM quando aplicável |
| BA Practitioners Guide 2ª Ed. | `../docs/business-analysis/ba-practitioners-guide-2nd.pdf` | Ligar narrativa de entrega a critérios de aceitação e necessidades de negócio |
| Nano-Banana Framework | `../docs/frameworks-and-modern-delivery/nano-banana-framework-paper.pdf` | Framework experimental de referência para relatórios de squads |
| Spec-Driven Development (PT) | `../docs/frameworks-and-modern-delivery/spec-driven-development-guide-por.pdf` | Alinhar relatórios com ciclos de entrega orientados a especificação |
| PMBOK Process Flow 8ª Ed. (A0) | `../docs/visual-references/pmbok-process-flows/pmbok-flow-8th-color-a0.pdf` | Facilitar workshops com squads sobre integração de processos e handoffs |
| Process Groups Simplified (A4) | `../docs/visual-references/simplified-process-posters/process-groups-simplified-a4.pdf` | Suporte visual em reviews de entrega com não-especialistas |

**Adição — novas obras (2026-04-03):**

| Documento | Caminho | Quando usar |
|---|---|---|
| Software Extension PMBOK 5th Ed. | `../docs/standards/project-management/software-extension-pmbok-guide-5th.pdf` | Critérios de aceitação de software (V&V) em relatórios de entrega de squads |
| PMBOK Guide 8ª Ed. (EN) | `../docs/standards/project-management/pmbok-guide-8th-eng.pdf` | Benefit realization metrics do MMA catalog; Lead vs Lag no relatório de entrega |
