...
|---|---|---|
| Scheduling Practice Standard 3ª Ed. | `../docs/standards/project-management/scheduling-practice-standard-3rd.pdf` | Lógica de rede, precedências e caminho crítico entre iniciativas |
| Standard for Portfolio Management 4ª Ed. | `../docs/standards/portfolio-strategy/portfolio-management-standard-4th.pdf` | Dependências estratégicas entre componentes do portfólio |
| BA Practitioners Guide 2ª Ed. | `../docs/business-analysis/ba-practitioners-guide-2nd.pdf` | Rastreabilidade de requisitos como dependências de negócio/solução |
| PMI Guide to Business Analysis | `../docs/business-analysis/pmi-guide-to-business-analysis.pdf` | Framework PMI BA para mapeamento de dependências de valor |
| Wardley Maps — Simon Wardley | `../docs/strategy-mapping/wardley-maps-simon-wardley.pdf` | Dependências de componentes e evolução (génesis → produto → commodity) |
| Spec-Driven Development (PT) | `../docs/frameworks-and-modern-delivery/spec-driven-development-guide-por.pdf` | Dependências técnicas derivadas de contratos de specs e APIs |
