...
|---|---|---|
| Standard for Portfolio Management 4ª Ed. | `../docs/standards/portfolio-strategy/portfolio-management-standard-4th.pdf` | KPIs de portfólio, trade-offs e narrativa para comité/board |
| OPM Standard | `../docs/standards/portfolio-strategy/opm-organizational-project-management-standard.pdf` | Enquadrar relatórios na maturidade e alinhamento estratégico |
| Earned Value Management Standard | `../docs/standards/project-management/earned-value-management-standard.pdf` | Resumo EVM (SPI, CPI) para decisões de correcção executiva |
| PMO Practice Guide (PT) | `../docs/practice-guides/pmo-and-processes/pmo-practice-guide-por.pdf` | Boas práticas de reporting ascendente e rituais de governance |
| Managing Change in Organizations | `../docs/practice-guides/organizational-change/managing-change-organizations-practice-guide.pdf` | Comunicar impacto, audiências e curvas de adoção a patrocinadores |
| Wardley Maps — Simon Wardley | `../docs/strategy-mapping/wardley-maps-simon-wardley.pdf` | Storylines estratégicas com visual de onde competir/construir/comprar |
| Leading AI Transformation | `../docs/transformation/leading-ai-transformation.pdf` | Mensagens de liderança e oportunidades de IA para o board |
