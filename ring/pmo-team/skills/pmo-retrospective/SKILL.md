...
|---|---|---|
| PMBOK Guide 7ª Ed. (PT) | `../docs/standards/project-management/pmbok-guide-7th-por.pdf` | Lições aprendidas como domínio de desempenho e saída de encerramento |
| PMO Practice Guide (PT) | `../docs/practice-guides/pmo-and-processes/pmo-practice-guide-por.pdf` | Evolução contínua da função PMO — o que melhorar no "escritório" |
| Managing Change in Organizations | `../docs/practice-guides/organizational-change/managing-change-organizations-practice-guide.pdf` | Dinâmica humana, resistências e factores críticos de sucesso em mudanças |
| Leading AI Transformation | `../docs/transformation/leading-ai-transformation.pdf` | Lições sobre adoção de IA, mudança cultural e gestão de transição |
| Process Groups Practice Guide (EN) | `../docs/standards/project-management/process-groups-practice-guide-eng.pdf` | Referência de entradas/saídas esperadas por fase para avaliação retrospectiva |
