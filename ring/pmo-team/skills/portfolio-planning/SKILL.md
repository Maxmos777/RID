...
|---|---|---|
| Standard for Portfolio Management 4ª Ed. | `../docs/standards/portfolio-strategy/portfolio-management-standard-4th.pdf` | Critérios de seleção, balanceamento e ciclo de vida de portfólio |
| OPM Standard | `../docs/standards/portfolio-strategy/opm-organizational-project-management-standard.pdf` | OPM como sistema estratégia → portfólio → projecto |
| PMBOK Guide 7ª Ed. (PT) | `../docs/standards/project-management/pmbok-guide-7th-por.pdf` | Referência normativa de domínios de desempenho |
| PMO Practice Guide (PT) | `../docs/practice-guides/pmo-and-processes/pmo-practice-guide-por.pdf` | Serviços PMO de suporte ao portfólio |
| Wardley Maps — Simon Wardley | `../docs/strategy-mapping/wardley-maps-simon-wardley.pdf` | Posicionar iniciativas em mapas de valor/cadeia para decisões de investimento |
| Wardley Mapping — Resumo (PT) | `../docs/strategy-mapping/wardley-mapping-resumo-abrangente-por.pdf` | Versão condensada do Wardley em português |
| Leading AI Transformation | `../docs/transformation/leading-ai-transformation.pdf` | Incorporar iniciativas de IA no mix de portfólio |
| PMI Guide to Business Analysis | `../docs/business-analysis/pmi-guide-to-business-analysis.pdf` | Priorização baseada em resultados de negócio |
| Nano-Banana Framework | `../docs/frameworks-and-modern-delivery/nano-banana-framework-paper.pdf` | Framework complementar para avaliação de portfólio |

**Adição — novas obras (2026-04-03):**

| Documento | Caminho | Quando usar |
|---|---|---|
| OPM Standard Vol. 1 | `../docs/standards/project-management/opm-standard-volume-1.pdf` | Framework de alinhamento portfólio → estratégia; OPM3 maturity dimensions |
| PMBOK Guide 8ª Ed. (EN) | `../docs/standards/project-management/pmbok-guide-8th-eng.pdf` | Tailoring guidance por tipo de projecto; MMA catalog para decisões de portfólio |
