...
|---|---|---|
| PMBOK Guide 7ª Ed. (PT) | `../docs/standards/project-management/pmbok-guide-7th-por.pdf` | Alinhamento com áreas e domínios de desempenho |
| Earned Value Management Standard | `../docs/standards/project-management/earned-value-management-standard.pdf` | PV, EV, AC, SPI, CPI — diagnóstico de prazo/custo |
| Scheduling Practice Standard 3ª Ed. | `../docs/standards/project-management/scheduling-practice-standard-3rd.pdf` | Qualidade de baseline, caminho crítico e rede de actividades |
| Process Groups Practice Guide (EN) | `../docs/standards/project-management/process-groups-practice-guide-eng.pdf` | Checklist de processos por grupo/fase para identificar gaps |
| OPM Standard | `../docs/standards/portfolio-strategy/opm-organizational-project-management-standard.pdf` | Coerência com modelo organizacional de execução |
| BA Practitioners Guide 2ª Ed. | `../docs/business-analysis/ba-practitioners-guide-2nd.pdf` | Maturidade de descoberta e qualidade de requisitos |
| PMBOK Process Flow 8ª Ed. (A0) | `../docs/visual-references/pmbok-process-flows/pmbok-flow-8th-color-a0.pdf` | Mapa visual rápido de processos para identificar gaps |
| Process Groups Simplified (A4) | `../docs/visual-references/simplified-process-posters/process-groups-simplified-a4.pdf` | Cartaz de sondagem rápida em revisões de saúde |

**Adição — novas obras (2026-04-03):**

| Documento | Caminho | Quando usar |
|---|---|---|
| Software Extension PMBOK 5th Ed. | `../docs/standards/project-management/software-extension-pmbok-guide-5th.pdf` | Indicadores específicos de software: defect density, technical debt ratio, change failure rate |
| PMBOK Guide 8ª Ed. (EN) | `../docs/standards/project-management/pmbok-guide-8th-eng.pdf` | Lead vs Lag indicators; MMA catalog para métricas de saúde actualizadas |
| OPM Standard Vol. 1 | `../docs/standards/project-management/opm-standard-volume-1.pdf` | Coerência com modelo de maturidade OPM3 (padronizar, medir, controlar, melhorar) |
