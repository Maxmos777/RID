...
|---|---|---|
| PMBOK Guide 7ª Ed. (PT) | `../docs/standards/project-management/pmbok-guide-7th-por.pdf` | Referência normativa de gestão de recursos (domínio de equipa) |
| Scheduling Practice Standard 3ª Ed. | `../docs/standards/project-management/scheduling-practice-standard-3rd.pdf` | Nivelamento de recursos, calendários e carga no tempo |
| Earned Value Management Standard | `../docs/standards/project-management/earned-value-management-standard.pdf` | Replaneamento de capacidade quando desvios EVM exigem mitigação |
| OPM Standard | `../docs/standards/portfolio-strategy/opm-organizational-project-management-standard.pdf` | Capacidade organizacional e maturidade de gestão de recursos |
