...
|---|---|---|
| PMBOK Guide 7ª Ed. (PT) | `../docs/standards/project-management/pmbok-guide-7th-por.pdf` | Estruturar riscos, incertezas e abordagens de resposta (Cap. Incerteza) |
| Earned Value Management Standard | `../docs/standards/project-management/earned-value-management-standard.pdf` | Riscos de custo/prazo com métricas EVM (PV, EV, CPI, SPI) |
| Managing Change in Organizations | `../docs/practice-guides/organizational-change/managing-change-organizations-practice-guide.pdf` | Riscos organizacionais e de adoção além do RAID técnico |
| OPM Standard | `../docs/standards/portfolio-strategy/opm-organizational-project-management-standard.pdf` | Riscos de capacidade organizacional e alinhamento estratégico |

**Adição — novas obras (2026-04-03):**

| Documento | Caminho | Quando usar |
|---|---|---|
| PMBOK Guide 8ª Ed. (EN) | `../docs/standards/project-management/pmbok-guide-8th-eng.pdf` | Distinção variability vs ambiguity risks; escalation thresholds do Uncertainty Domain |
| Software Extension PMBOK 5th Ed. | `../docs/standards/project-management/software-extension-pmbok-guide-5th.pdf` | Technical debt como risco gerível; riscos específicos de software (integration failure, obsolescence) |
