...
Referências bibliográficas disponíveis em `../docs/`. Carregar quando for necessário fundamentar uma análise, linguagem normativa ou framework específico.

| Documento | Caminho | Quando usar |
|---|---|---|
| PMO Practice Guide (PT) | `../docs/practice-guides/pmo-and-processes/pmo-practice-guide-por.pdf` | Desenho de funções PMO, modelos de serviço, governance |
| PMBOK Guide 7ª Ed. (PT) | `../docs/standards/project-management/pmbok-guide-7th-por.pdf` | Âncora normativa e linguagem PMI para pedidos |
| Standard for Portfolio Management 4ª Ed. | `../docs/standards/portfolio-strategy/portfolio-management-standard-4th.pdf` | Critérios de portfólio e KPIs |
| OPM Standard | `../docs/standards/portfolio-strategy/opm-organizational-project-management-standard.pdf` | Papéis do PMO na ponte estratégia → entrega |
| Process Groups Practice Guide (EN) | `../docs/standards/project-management/process-groups-practice-guide-eng.pdf` | Linguagem de grupos de processo e gates |
| Managing Change in Organizations | `../docs/practice-guides/organizational-change/managing-change-organizations-practice-guide.pdf` | PMO como facilitador de mudança |
| Leading AI Transformation | `../docs/transformation/leading-ai-transformation.pdf` | Governance PMO em transformações com IA |
| Spec-Driven Development (PT) | `../docs/frameworks-and-modern-delivery/spec-driven-development-guide-por.pdf` | Harmonizar PMO com engenharia spec-first |
| PMBOK Process Flow 8ª Ed. A0 | `../docs/visual-references/pmbok-process-flows/pmbok-flow-8th-color-a0.pdf` | Referência visual rápida de processos |

**Adição — novas obras (2026-04-03):**

| Documento | Caminho | Quando usar |
|---|---|---|
| PMBOK Guide 8ª Ed. (EN) | `../docs/standards/project-management/pmbok-guide-8th-eng.pdf` | Edição mais recente — referência de base actualizada; Performance Domains e MMA catalog |
| Software Extension PMBOK 5th Ed. | `../docs/standards/project-management/software-extension-pmbok-guide-5th.pdf` | PMO de projectos de software: software lifecycle, V&V gates, configuration management |
| OPM Standard Vol. 1 | `../docs/standards/project-management/opm-standard-volume-1.pdf` | Governance organizacional e alinhamento estratégico do PMO |
